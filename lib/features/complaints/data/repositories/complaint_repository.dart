...
abstract class ComplaintRepository {
  ...
  Future<Either<Failure, ComplaintModel>> createComplaint(AddComplaintParams params);
  Future<Either<Failure, ComplaintModel>> sendMessage({
...
class ComplaintRepositoryImpl implements ComplaintRepository {
  ...
  @override
  Future<Either<Failure, ComplaintModel>> createComplaint(AddComplaintParams params) async {
    if (await networkInfo.isConnected) {
      try {
        final data = await remote.createComplaint(params);
        return Right(data);
      } on ServerException catch (e) {
        return Left(ServerFailure(e.message));
      }
