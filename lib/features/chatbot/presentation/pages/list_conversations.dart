...
class _ChatHistoryDrawerState extends State<ChatHistoryDrawer> {
      ...
      child: SafeArea(
        child: Column(
          children: [
            ...
            Center(child: Text('Chat History', style: AppStyle.h4.copyWith(color: AppColors.tertiaryColor))),
            SizedBox(height: 8.h),
            Expanded(
  ...
  Widget _builder(BuildContext context, ChatBotState state) {
      ...
      final activeConversationId = context.read<ChatBotCubit>().currentConversationId;

      if (state is ConversationsSuccess && state.conversations.conversations.isEmpty) {
        return const EmptyWidget(title: 'no_solar_consultations',subtitle: 'ask_first_question');
      }
